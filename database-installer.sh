...
TARGET_DIR="/$HOME/xtreamui"
SQL_DIR="/$HOME/xtreamui/mysql"
...
unzip -q /tmp/mysql-database.zip -d "$TARGET_DIR"

# Set file and folder permissions to 102:103 recursively
chown -R 111:121 "$TARGET_DIR/mysql"
